...
{	
	...
	public void click_on_login() throws InterruptedException 
	{
		...
		/*WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(300, 30));
		WebElement Checkbox = wait.until(ExpectedConditions.elementToBeClickable(By.id("cb-i"))); 
...
String expectedName = "	Victoria Terces";
	...
	public void teardown(Scenario sc)
	{
		...
		if(sc.isFailed()==true)
		{
			...
			String fileWithPath = "C:\\CucumberFramework\\Screenshot\\Error.png";
